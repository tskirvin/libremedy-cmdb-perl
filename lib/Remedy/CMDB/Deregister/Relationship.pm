...
Remedy::CMDB::Deregister::Relationship - a single relationship dereg
...
Remedy::CMDB::Deregister::Relationship records information about a single entry
in the CMDB, and offers functionality to both search the database for that
information and to update the information when appropriate.

Remedy::CMDB::Deregister::Relationship is a sub-class of
B<Remedy::CMDB::Struct>, and inherits many functions from there.
