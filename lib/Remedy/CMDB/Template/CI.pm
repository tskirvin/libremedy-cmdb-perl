package Remedy::CMDB::Template::CI;
our $VERSION = "0.50";
...
TODO: re-write Item.pm into a CI type, and have the Deregister classes (for
starters) inherit from it.
...
sub tag_type { 'invalid ci type' }


sub element_type { 'invalid element type' }
...
sub find {
    ...
    my $class = $args{'class'} || $self->element_type;
